...
import { initOverlay, openTool } from './overlay.2404daeb1c.js';
import { mountRoomScreens } from './screens.4626e3532f.js';
import { initChefWall } from './chefwall.2e2da0a5e6.js';
import { initLabels } from './labels.d881f413f8.js';
import { buildWallPrint, revealWallPrints } from './wallprint.743c066f9c.js';
...
import { ROOM_ORDER, HOTSPOTS, CHEF_FRAMES, FREEZER_DOOR } from '../rooms.77595ae61c.js';
...
async function loadData() {
  ...
  const [tools, headchefs] = await Promise.all([
    fetch('data/tools.1b9013b491.json').then((r) => r.json()),
 ...
 *                 hotspot either. The tool is still in data/tools.1b9013b491.json and so
 ...
 * one `"object": "no-chip"` in data/tools.1b9013b491.json and no code change at all.
 */
...
function buildChip(tool, staged, i) {
  ...
  /* THE MARQUEE. A tool carrying `marquee` in data/tools.1b9013b491.json gets the bulb
